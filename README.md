...
3. The operations of recording, recording, previewing, and taking photos are mutually exclusive. That is, when other operations are being opened or closed, the APP should prohibit users from performing these four operations before the device notifies the operation result to prevent device problems  
