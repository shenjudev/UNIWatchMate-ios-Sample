...
//        sheet.show(icon: nil, title: R.string.tips.相册访问权限未开启().attributed, alignment: .center, leftTitle: "取消".by, rightTitle: "去设置") {
//            
//        } rightClosure: {
...
//        let sheet = R.nib.tsAlertSheetView(owner: nil)!
//        sheet.show(icon: nil, title: R.string.tips.摄像头权限未开启().attributed, alignment: .center, leftTitle: "取消".by, rightTitle: "去设置") {
//            
//        } rightClosure: {
//            TSBLEPermissions.shared.openAppSettings()
//        }
