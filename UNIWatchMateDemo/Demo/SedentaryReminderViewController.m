...
NSString *NSStringFromWMTimeFrequency(WMTimeFrequency timeFrequency) {
...
- (UIDatePicker *)startDate {
    if (!_startDate) {
        ...
        _startDate.datePickerMode = UIDatePickerModeTime; 
        
        [_startDate setMinuteInterval:1];
...
- (UIDatePicker *)endDate {
    if (!_endDate) {
        ...
        _endDate.datePickerMode = UIDatePickerModeTime;
        
        [_endDate setMinuteInterval:1];
...
- (UIDatePicker *)noDisturbLunchBreakEndDate {
    if (!_noDisturbLunchBreakEndDate) {
        ...
        _noDisturbLunchBreakEndDate.datePickerMode = UIDatePickerModeTime;
        
        [_noDisturbLunchBreakEndDate setMinuteInterval:1];
...
- (void)viewDidLoad {
    ...
    _timeFrequencys = @[
        NSStringFromWMTimeFrequency(WMTimeFrequencyEvery30Minutes),
        NSStringFromWMTimeFrequency(WMTimeFrequencyEvery1Hour),
        NSStringFromWMTimeFrequency(WMTimeFrequencyEvery1Hour30Minutes),
...
-(void)listen{
    @weakify(self);
    [[WatchManager sharedInstance].currentValue.settings.sedentaryReminder.model subscribeNext:^(WMReminderModel * _Nullable x) {
        @strongify(self);
        [self showDetail:x];
...
- (NSString *)getHourAndMMFromDate:(NSDate *)date {
    ...
    // 3. Sets the format of the date formatter
